---
title: LDS Retention Is Higher Than Most Other Christian Traditions
scripture:
related:
  - "[[Church Is Hemorrhaging Members at a Unique Rate]]"
  - "[[Why the LDS Membership Lacks a Large Nominal Middle]]"
...
## The Claim
When the comparison is widened to peer religions, the Church of Jesus Christ of Latter-day Saints retains its members — and especially its *active* members — at the top of the field, even as it has declined in absolute terms.

## Supporting Evidence

1. **Two retention measures, both favorable (rated: strong, Pew).** Dyer distinguishes (a) still *identifying* as Latter-day Saint from (b) identifying *and* attending regularly. On the Pew data, "those who stayed a member of their church as well as were attending that church regularly — Latter-day Saints were the highest in that."[^1]

2. **Decline is milder than peers (rated: strong).** "Have we declined in retention over time? The answer is yes. Not as much as most other Christian traditions in particular. And particularly with active retention, we're at... the top of that list."[^2]
...
> "Particularly with active retention, we're at... the top of that list."[^2]
