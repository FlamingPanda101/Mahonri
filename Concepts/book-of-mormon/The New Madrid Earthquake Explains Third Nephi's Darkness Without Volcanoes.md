---
title: "The New Madrid Earthquake Explains Third Nephi's Darkness Without Volcanoes"
scripture:
  - "[[3 Nephi 9|3 Nephi 8-9]]"
related:
...
## The Claim
A standard argument *for* a Mesoamerican setting is that [[3 Nephi 9|3 Nephi]]'s destruction at Christ's death — three days of darkness, "vapor of darkness," cities sunk and burned — requires volcanoes, which Mesoamerica has and North America (around a New York Cumorah) lacks. [[Jonathan Neville]] answers that the **1811–1812 New Madrid earthquakes** along the Mississippi produced exactly the described phenomena *without* any volcano.[^1]

## Supporting Evidence
1. **The earthquake matched the text.** The New Madrid quakes (felt as far as Boston, ringing church bells in New England) produced "sand blows" that filled the air and "blanketed the sun, the moon and the stars" for days of pitch darkness; survivors reported they "couldn't light fires" because of the mist — paralleling the [[3 Nephi 9|3 Nephi 8]] detail that the people could kindle no fire in the "vapor of darkness."[^1] *(Moderate — the documented effects do broadly match; whether they match *better* than a volcano is the contested point.)*
...
## Best Quotes
> "All the description in Third Nephi was validated by the people who survived during this earthquake at the New Madrid fault. So you don't need to have a volcano."[^1]

> "When people ask me about, well, there's no volcanoes around Cumorah — I say, well, there's no volcanoes in the Book of Mormon either... it's just black smoke, black vapor where they couldn't light fires."[^2]
