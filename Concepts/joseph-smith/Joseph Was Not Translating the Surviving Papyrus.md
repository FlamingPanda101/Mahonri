---
title: "Joseph Was Not Translating the Surviving Papyrus"
related:
...
Egyptologist [[Kerry Muhlestein]] (on [[Ward Radio]]) answers the **leading attack** on the [[Book of Abraham]]: the argument that Joseph translated the *surviving* Joseph Smith papyrus, that Egyptologists read those fragments as a routine funerary "Book of Breathings," and therefore that Joseph's translation is demonstrably wrong. Muhlestein's reply: the **historical eyewitness sources** describe Joseph translating from a **different, now-lost scroll**, not from the recovered fragments — so the whole argument is, in his word, "illusory." It assumes the very thing in dispute (that the surviving piece is the source of the text).[^1]
...
### 3. The objection conflates a prophet with an academic translator — rate: moderate (framing)
Even setting aside the missing-scroll point, "translation" in Joseph's prophetic sense need not be a word-for-word Egyptological rendering of the characters on a given fragment. The critic's argument silently imports a modern academic-translation standard. See [[A Prophet Is Not an Academic Translator]] and the separate text-vs-drawing distinction in [[Translating a Text Versus Interpreting a Drawing Are Different Claims]].[^1]
