...
- in **Fine-Tuning - Book of Mormon Anticipation of Modern Cosmology.md** → `[[Fine-Tuning and the Teleological Argument
from Alma 30]]` (no such note)
- in **Fine-Tuning - Book of Mormon Anticipation of Modern Cosmology.md** → `[[David Butler]]` (no such note)
- in **Fine-Tuning - Book of Mormon Anticipation of Modern Cosmology.md** → `[[Hayden
> Carroll]]` (no such note)
